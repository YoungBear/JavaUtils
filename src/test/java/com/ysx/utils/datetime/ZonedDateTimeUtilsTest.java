...
public class ZonedDateTimeUtilsTest {
    ...
    public void long2StringTest() {
        ...
        Assertions.assertEquals(dateStr1, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_ZONED_DATE_TIME));
        String dateStr2 = "2022-06-15T22:06:29.483+08:00";
        Assertions.assertEquals(dateStr2, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_OFFSET_DATE_TIME));
        String dateStr3 = "2022-06-15T22:06:29.483";
        Assertions.assertEquals(dateStr3, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_LOCAL_DATE_TIME));

        // 分别对应 pattern 字符串如下
        String pattern1 = "yyyy-MM-dd'T'HH:mm:ss.SSSxxx'['VV']'";
        Assertions.assertEquals(dateStr1, ZonedDateTimeUtils.long2String(timestamp, pattern1));
        String pattern2 = "yyyy-MM-dd'T'HH:mm:ss.SSSxxx";
        Assertions.assertEquals(dateStr2, ZonedDateTimeUtils.long2String(timestamp, pattern2));
        String pattern3 = "yyyy-MM-dd'T'HH:mm:ss.SSS";
        Assertions.assertEquals(dateStr3, ZonedDateTimeUtils.long2String(timestamp, pattern3));
    ...
    public void string2longTest() {
        ...
        Assertions.assertEquals(timestamp, timestamp1);
        long timestamp11 = ZonedDateTimeUtils.string2long(str1, "yyyy-MM-dd'T'HH:mm:ss.SSSxxx'['VV']'");
        Assertions.assertEquals(timestamp, timestamp11);
...
//        Assertions.assertEquals(timestamp, timestamp3);
    ...
    public void long2StringWithZoneIdTest() {
        ...
        Assertions.assertEquals(dateStringShanghai, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_ZONED_DATE_TIME));
        ...
        Assertions.assertEquals(dateStringMoscow, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_ZONED_DATE_TIME, zoneIdMoscow));
        ...
        Assertions.assertEquals(dateStringParis, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_ZONED_DATE_TIME, zoneIdParis));
        ...
        Assertions.assertEquals(dateStringLos_Angeles, ZonedDateTimeUtils.long2String(timestamp, DateTimeFormatter.ISO_ZONED_DATE_TIME, zoneIdLos_Angeles));
    }
